                      ...
                      <div class="dropdown-chart">
                        ...
                        <div class="dropdownpadi" id="faseAmatan">
                            ...
                            <select style="background-color: #a4d17c; border: transparent;color: #FFFFFF;font-weight: bold;">
                                ...
                                <option>03-Generatif</option>
                                <option>04-Panen</option>
                                <option>05-Persiapan Lahan</option>
                                <option>06-Puso</option>
                                <option>07-Lahan Pertanian Bukan Padi</option>
                                <option>08-Bukan Lahan Pertanian</option>
                                <option>12-Tidak Bisa Diamati</option>
                            </select>
                        </div>
